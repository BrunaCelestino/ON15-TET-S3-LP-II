 ...
 var desconto = 0;
            ...
            // -- Maior que 50, menor que 80:     
                if(clientes[i].valor>=50 && clientes[i].valor<80){
                    ...
                    var desconto1 = Number(clientes[i].valor /100 *5); 
...
//  - Ttotal com desconto:       
        ...
        console.log(`
            ...
            O seu total sem desconto foi: R$${total.toFixed(2)}
            você recebeu um desconto total de: R$${descontoTotal.toFixed(2)}
            Sua compra, com desconto, ficou no total de: R$${totalComDesconto.toFixed(2)}
        `);
...
//  # INICIO RECIBO: 
        ...
        console.table({
            ...
            'Valor Total sem Desconto':`R$ ${total.toFixed(2)}`,
            'Desconto Recebido': `R$ ${descontoTotal.toFixed(2)}`,
            'Valor Total com Desconto':`R$ ${totalComDesconto.toFixed(2)}`
        });
//  FIM RECIBO # 
